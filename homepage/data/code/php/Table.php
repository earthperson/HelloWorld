Table Класс для упрощения работы с html таблицами
<?php
/**
 * Class for convenience work with tables.
 * 
...
class Table {
	...
	public function th($html = '', $plain_text = true, $attributes = '') {
		$this->mode = 'th';
		$this->cells[] = array('html'=>($plain_text ? $this->plain_text($html) : $html), 'attributes'=>$attributes);
	}
	...
	public function td($html = '', $attributes = '', $plain_text = false) {
		...
		$this->mode = 'td';
		$this->cells[] = array('html'=>($plain_text ? $this->br_plain_text($html) : $html), 'attributes'=>$attributes);
	}
	...
	protected function plain_text($str) {
		return htmlspecialchars($str, ENT_QUOTES);
	}
	
	protected function br_plain_text($str) {
		return nl2br($this->plain_text($str));
	}
}
?>