...
<div style="text-align: center; padding-bottom: 14px;">
   <noscript>Для отображения карты необходимо включить поддержку JavaScript</noscript>
   <div style="padding-bottom: 14px;">
   <form action="#" method="post" onsubmit="showAddress(this.address.value); return false;">
   Адрес: <input type="text" name="address" id="address" style="width: 660px;" onfocus="this.style.borderColor = '#3300cc';" onblur="this.style.borderColor = 'black';" />
