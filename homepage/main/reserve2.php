...
$head_content .= include_stylesheet('../engine/common/styles.css', '../engine/reserve2/styles.css');
...
//]]>
</script>', '../engine/common/script.js', '../engine/reserve2/script.js');
...
<div class="section_title">Резервная страница</div>
